...
const Steps = () => {
  return (
    <div className="flex flex-col md:flex-row items-center gap-10 md:gap-40 mx-4 lg:mx-44 py-30 xl:py-46">
      <h1 className="pb-2 w-full text-center text-3xl md:text-3xl lg:text-7xl mt-4 font-bold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent">
        Steps to remove background or Inhance <br />
        image in seconds
      </h1>

      <div className="flex flex-col items-start flex-wrap gap-4 justify-center w-full">
        <div className="w-full flex items-start gap-4 bg-white border border-neutral-300 rounded-3xl drop-shadow-md p-7 pb-10   transition-all duration-500">
          <img
            className="max-w-9"
        ...
        <div className="flex w-full items-start gap-4 bg-white border border-neutral-300 rounded-3xl drop-shadow-md p-7 pb-10   transition-all duration-500">
          <img
            className="max-w-9"
          ...
          />
          <div>
            <p className="text-xl font-medium">Let AI do the work</p>
            <p className="text-sm text-neutral-500 mt-1">
              This is a demo text, will replace it later. <br /> This is a
              demo..
            </p>
