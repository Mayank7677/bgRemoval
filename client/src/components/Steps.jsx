...
const Steps = () => {
  return (
    <div className="mx-4 lg:mx-44 py-20 xl:py-46">
      ...
      <div className="flex items-start flex-wrap gap-4 mt-16 xl:mt-24 justify-center">
        <div className="flex items-start gap-4 bg-white border border-neutral-300 rounded-3xl drop-shadow-md p-7 pb-10  hover:scale-105 transition-all duration-500">
          <img
            className="max-w-9"
